...
public class SecurityConfig 
{
	...
	private static final RequestMatcher[] CSRF_IGNORED = new RequestMatcher[] {
	    ...
	    new AntPathRequestMatcher("/savepost/**"),
		new AntPathRequestMatcher("/getpost/{id}"), 
		new AntPathRequestMatcher("/updatepost/{id}"),
		new AntPathRequestMatcher("/getAllpost"),
		new AntPathRequestMatcher("/deletepost/{id}"),
		new AntPathRequestMatcher("/hrcreated")
